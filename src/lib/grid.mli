...
module Grid : sig
  ...
  val place_words_from_list_vertical_search : t -> string list -> int -> int -> WordCoords.t -> t * WordCoords.t
  val place_words_from_list_horizontal_search : t -> string list -> int -> int -> WordCoords.t -> t * WordCoords.t
  val place_final_words : t -> string list -> int -> int -> WordCoords.t -> t * WordCoords.t
